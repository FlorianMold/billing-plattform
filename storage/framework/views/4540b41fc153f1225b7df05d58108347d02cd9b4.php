...
<html lang="gm">
    <head>
        ...
        <?php $__env->startSection('css'); ?>
            ...
            <link rel="stylesheet" href="<?php echo e(URL::asset('css/adminBackend.css')); ?>">
    ...
    <body>
                ...
                <ul class="nav navbar-top-links navbar-right hidden-xs">
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                            <i class="fa fa-user fa-fw"></i> <?php echo e($user->username); ?> <i class="fa fa-caret-down"></i>
                        </a>
                        <ul class="dropdown-menu dropdown-user">
                            <li>
                                <a href="/changePassword/<?php echo e($userid); ?>"><i class="fa fa-gear fa-fw"></i> Passwort ändern</a>
                            </li>
                            <li class="divider"></li>
                            <li>
                    ...
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav side-menu">
                            ...
                            <li class="hidden-md hidden-lg hidden-sm">
                                <a href="#"><i class="fa fa-user fa-fw"></i> <?php echo e($user->username); ?><span class="fa arrow"></span></a>
        ...
        <?php $__env->startSection('js'); ?>
            ...
            <script type="text/javascript" src="<?php echo e(URL::asset('js/scripts_backend.js')); ?>"></script>
