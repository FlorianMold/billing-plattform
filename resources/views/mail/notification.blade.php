...
<p>Ein Lieferant hat bei der Rechnung mit dieser Rechnungsnummer <b>{{$billinfo->id}}</b> einen Fehler entdeckt.</p>
<p>Unten steht die genaue Beschreibung des Fehlers:</p>
<br>
<h3>{{$billinfo->mail_title}}</h3>
<p>{{$billinfo->mail_desc}}</p>
<br><br>
