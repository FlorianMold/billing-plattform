<body>
    ...
    <p>Ihr Benutzer des Unternehmens <b>{{ $user->adr_name }}</b> wurde nun für unsere Rechnungsplattform freigeschaltet!</p>
    <p>Bitte melden Sie sich nun auf unserer Rechnungsplattform (<a href="{{ $url }}">Rechnungsplattform</a>) mit ihrer angegebenen E-Mail und ihrem gesetzten Passwort an.</p>
