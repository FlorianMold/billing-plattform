<body>
    ...
    <p>Ihr Benutzer des Unternehmens <b>{{ $user->adr_name }}</b> wurde von unserer Rechnungsplattform gelöscht!</p>
    <p>Wenn Sie noch einen Zugang zu unserer Plattform benötigen, melden Sie sich bitte erneut an! Falls Sie nicht freigeschaltet werden, nehmen Sie bitte mit unserem Unternehmen ELK Fertighaus GmbH - Standort Schrems kontakt auf!</p>
