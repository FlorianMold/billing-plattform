...
<p>Wenn Sie eine Zurücksetzungs-Anfrage für {{$user->username }} gestellt haben, klicken Sie bitte auf die Schaltfläche unten. Sollte diese Anfrage nicht von Ihnen stammen, können Sie diese E-Mail ignorieren.</p>
<br>
<a href="{{$url}}" class="btn btn-lg btn-primary center-block">Passwort zurücksetzen</a><br><br>
<br><br>
