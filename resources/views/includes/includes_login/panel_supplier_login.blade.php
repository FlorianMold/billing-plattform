...
<div class="tab-pane active" id="panel_supplier_login">
    ...
    <div class="row">
        ...
        <div class="col-xs-offset-1 col-sm-offset-1 col-md-offset-1 col-lg-offset-3 col-xs-10 col-sm-10 col-md-10 col-lg-6">
            <!-- Login Form -->
            {!! Form::open(array('url' => 'loginSupplier', 'class' => 'form-horizontal')) !!}
            ...
            <div class="form-group">
                <div class="col-xs-6 col-md-6 col-sm-6 col-lg-6">
                    {!!  Form::button('Registieren', array('class' => 'btn btn-default', 'data-toggle' => 'modal', 'data-target' => '#register_supplier_popup_login')) !!}
                </div>
