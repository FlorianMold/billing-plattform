                ...
                <div class="modal-body">    <!-- style="height: 330px;" -->
                    <div class="form-group">
                        <div class="form-group">
                            ...
                            {!! Form::text(null, null,  array('class' => 'form-control', 'readonly', 'id' => 'notification_title_accounting')) !!}
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-group">
                            {!! Form::label('desc_label', 'Genaue Beschreibung des Problems:') !!}
                            {!! Form::textarea(null, null,  array('class' => 'form-control', 'readonly', 'id' => 'notification_text_accounting', 'style' => 'resize: vertical; max-height: 200px; min-height: 200px;')) !!}
                        </div>
                    </div>
                </div>
